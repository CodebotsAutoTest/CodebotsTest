...
namespace APITests.EntityObjects.Models
{
	public class AEntity : BaseEntity
	{
		...
		/// </summary>
		/// <see cref="Lm2348.Models.Bssssdasd"/>
		public List<Guid> BssssdasdIds { get; set; }
		...
		public AEntity(ConfigureOptions option)
		{
			Configure(option);
			InitialiseAttributes();
			InitialiseReferences();
		...
		// TODO needs some warning if trying to get an invalid entity, and the entity
		// attributes don't actually have any validators to violate.
		public static AEntity GetEntity(bool isValid, string fixedValue = null)
		{
		...
		public static AEntity GetInvalidEntity()
		{
			var aEntity = new AEntity
			{
			};
			return aEntity;
		}
		...
		/// Gets an entity with attributes that conform to any attribute validators.
		/// </summary>
		public static AEntity GetValidEntity(string fixedStrValue = null)
		{
			var aEntity = new AEntity
			{

				Dsds = (!string.IsNullOrWhiteSpace(fixedStrValue) && fixedStrValue.Length > 0 && fixedStrValue.Length <= 255) ? fixedStrValue : DataUtils.RandString(),
			};
		...
		{
			return SaveToDB<Lm2348.Models.AEntity>(AEntityDto.Convert(this));
		}
	}
}
