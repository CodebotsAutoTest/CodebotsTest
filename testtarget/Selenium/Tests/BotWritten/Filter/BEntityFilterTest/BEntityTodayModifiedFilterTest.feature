...
@BotWritten @Filter
Feature: BEntity filtered by today's modified Feature

@BEntity
Scenario: BEntity filtered by today's modified
Given I login to the site as a user
Given I have 10 valid BEntity entities
And I navigate to the BEntity backend page
When I click the filter Button on the BEntity page
