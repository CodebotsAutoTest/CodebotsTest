...
{
	///<summary>
	///The User Nav section represents the navigation bar that a logged in user would see
	///</summary>
	// % protected region % [Protected region incase the user Nav Section should not extend the base Nav Section] off begin
	public class UserNavSection : VisitorNavSection
	// % protected region % [Protected region incase the user Nav Section should not extend the base Nav Section] end
	{
		...
		// % protected region % [Add any methods which can be performed from the logged user navigation section] off begin
		// % protected region % [Add any methods which can be performed from the logged user navigation section] end
