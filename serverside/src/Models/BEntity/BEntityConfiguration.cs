...
namespace Lm2348.Models {
	public class BEntityConfiguration : IEntityTypeConfiguration<BEntity>
	{
		public void Configure(EntityTypeBuilder<BEntity> builder)
		{
			AbstractModelConfiguration.Configure(builder);

			// % protected region % [Override A Bssssdasds configuration here] off begin
			builder
				.HasOne(e => e.A)
				.WithMany(e => e.Bssssdasds)
				.OnDelete(DeleteBehavior.Restrict);
			// % protected region % [Override A Bssssdasds configuration here] end
